...
#]=========================================================]
add_executable (wrtd src/ripple/app/main/Application.h)
if (unity)
  target_sources (wrtd PRIVATE
    #[===============================[
       unity, main sources
    #]===============================]
...
target_link_libraries (wrtd
  Ripple::boost
  Ripple::opts
  Ripple::libs
  Ripple::xrpl_core)
exclude_if_included (wrtd)
# define a macro for tests that might need to
# be exluded or run differently in CI environment
if (is_ci)
  target_compile_definitions(wrtd PRIVATE RIPPLED_RUNNING_IN_CI)
endif ()
