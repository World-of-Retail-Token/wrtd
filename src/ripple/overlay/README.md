...
**wrtd**. Each peer maintains multiple outgoing connections and optional
...
fully connected directed graph of nodes where vertices are instances of wrtd
...
* _User Defined_ (Unimplemented)
    ...
    The wrtd operator may specify additional, optional fields and values
...
Cluster members are configured in the `wrtd.cfg` file under
