...
native currency, WRT. Fees for transactions are paid directly from the account
...
may want to change fees is when the value of the native currency WRT fluctuates
...
A validating instance of wrtd uses information in the configuration file
...
consensus to succeed, otherwise different instances of wrtd will get 
...
*  A pull request is created and the new code is folded into a wrtd build 
