...
**wrtd software**. Each peer maintains multiple outgoing connections and
...
**wrtd** is launched, the existing Bootcache database data is accessed and
...
outgoing connections to foreign peers. This security feature helps wrtd
